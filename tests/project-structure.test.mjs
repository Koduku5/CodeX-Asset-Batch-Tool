...
test('the product owns its engine, skills, UI, server and desktop boundaries', async () => {
  for (const relativePath of [
    ...
    'src/server/software-workspace/runtime-materialization.mjs',
    ...
    'src/server/pipeline-task/runtime-resolution.mjs',
    ...
    'engine/scripts/lib/image-job/job-selection.mjs',
    ...
    'engine/scripts/lib/api_batch/file_runtime.py',
    'engine/scripts/lib/api_batch/queue_validation.py',
    'engine/scripts/lib/api_batch/queue_freshness.py',
    'engine/scripts/lib/api_batch/queue_runtime.py',
    'engine/scripts/lib/api_batch/remote_client.py',
    'engine/scripts/lib/api_batch/item_runner.py',
    'engine/scripts/lib/api_batch/item_state.py',
    'engine/scripts/lib/api_batch/batch_lock.py',
    ...
    'desktop/PromptStudio.Desktop/MainWindow.Stage.cs',
    'desktop/PromptStudio.Desktop/MainWindow.BridgeScript.cs',
    'desktop/PromptStudio.Desktop/DesktopRpcBridge.ApiBatch.cs',
    'desktop/PromptStudio.Desktop/DesktopRpcBridge.Contracts.cs',
    'engine/scripts/lib/asset_record_validation.py',
    'engine/scripts/lib/asset_delivery_analysis.py',
    'engine/scripts/lib/asset_validation_receipt.py',
    'engine/scripts/lib/episode_asset_merge.py',
    'engine/scripts/lib/pending_asset_contracts.py',
    'engine/scripts/lib/pending_asset_episode.py',
    'engine/scripts/lib/pending_asset_identity.py',

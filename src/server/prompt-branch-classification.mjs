...
import {
  ...
  pageSchema,
  validateBaseQueue
} from './prompt-branch-classification/contracts.mjs';

export { PromptBranchClassificationError } from './prompt-branch-classification/contracts.mjs';
...
export async function createPromptBranchClassificationSession(projectRootInput, {
  ...
  try {
    ...
    if (!SHA256_PATTERN.test(catalogApi.catalogFingerprint)
      || !SHA256_PATTERN.test(catalogApi.conditionRegistryFingerprint)) {

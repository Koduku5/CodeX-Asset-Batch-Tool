...
const handleApi = async (request, response, pathname, services) => {
...
const handleDesktop = async (request, response, pathname, services, security) => {
...
const handleStatic = async (request, response, pathname, servedStaticRoot) => {
